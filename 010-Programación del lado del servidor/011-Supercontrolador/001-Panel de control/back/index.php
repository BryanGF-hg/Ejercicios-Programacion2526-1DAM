...
<html>
	<head>
      ...
      nav{background:#7FFFD4;padding:20px;gap:20px;flex:1;
      display:flex;flex-direction:column;gap:20px;}
      nav a{background:white;color:#7FFFD4;text-decoration:none;
      padding:10px;}
      main{padding:20px;flex:4;}
      table td{padding:10px;}
      table{border:2px solid #7FFFD4;width:100%;}
      th{background:#40e0d0;color:white;padding:10px;}
    </style>
  </head>
  <body>
    <?php
